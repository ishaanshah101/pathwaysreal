...
const rows = [
  ...
  ['Reddit & College Confidential', 'Open forums where great advice and guesswork sit side by side, unlabeled', 'Professors and counselors checked by hand against their institution's own page, so you know who is answering you'],
