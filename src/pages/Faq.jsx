...
const faqs = [
  ...
  { q: 'Who can use Pathways?', a: 'Any student 13 or older, from 9th grade up. College students use it for peer mentorship, and educators, professors, and admissions counselors apply to be verified mentors, and a person checks each one against their institution's public directory before the badge appears.' },
