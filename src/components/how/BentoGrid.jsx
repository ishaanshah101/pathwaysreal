...
const bento = [
  ...
  { span: 2, title: 'Verified mentors', body: 'Professors and counselors are checked by a person against their public faculty or staff page before they get the badge. Advice you can actually trust.', d: 'M20 6 9 17l-5-5', d2: '', iconBg: 'var(--color-accent-2-200)', iconFg: 'var(--color-accent-2-800)' },
