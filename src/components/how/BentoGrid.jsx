...
const bento = [
  ...
  { span: 2, title: 'Credibility you can earn', body: 'From Regular Bronze to Gold Triple Palm. Rated by the community, filtered by AI, professional enough to put on an application.', d: 'M11.5 2.6a1 1 0 0 1 1 0l2.6 5.3 5.9.9a1 1 0 0 1 .5 1.7l-4.2 4.1 1 5.8a1 1 0 0 1-1.5 1.1L12 18.7l-5.2 2.8a1 1 0 0 1-1.5-1.1l1-5.8-4.2-4.1a1 1 0 0 1 .5-1.7l5.9-.9z', d2: '', iconBg: 'var(--color-accent-100)', iconFg: 'var(--color-accent-700)' },
